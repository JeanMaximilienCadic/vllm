...
def get_requirements() -> List[str]:
    ...
    if _is_hip():
        with open(get_path("/opt/vllm/requirements/rocm.txt")) as f:
            requirements = f.read().strip().split("\n")
    elif _is_neuron():
        with open(get_path("/opt/vllm/requirements/neuron.txt")) as f:
            requirements = f.read().strip().split("\n")
    else:
        with open(get_path("/opt/vllm/requirements/base.txt")) as f:
            requirements = f.read().strip().split("\n")
    return requirements
